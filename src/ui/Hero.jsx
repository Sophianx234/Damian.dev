  ...
  return (
    ...
    <div className="md:grid lg:grid-cols-[2fr_1fr] md:grid-cols-[1fr_1fr]  flex-col-reverse flex items-center gap-8 md:max-w-6xl mx-auto md:pt-28 relative z-0 
     ">
      ...
      <div className="md:space-y-7 flex space-y-4 flex-col sm:space-y-4 items-center justify-center">
        ...
        <p className=" w-[40rem] lg:text-xl md:text-lg font-[Mulish] text-base text-center sm:text-center text-slate-600 md:pl-1 ">
