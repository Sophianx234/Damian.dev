...
function ProjectSection() {
    return (
        ...
        ">
            ...
            <h2 className="md:text-3xl font-semibold  text-center lg:text-left  text-slate-700 md:px-10 lg:px-0 text-2xl">Each project is a unique piece of development 🧩</h2>
